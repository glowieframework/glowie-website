...
From the component controller, you can manipulate its data through the `$this->component` object. It is a Glowie <a href="https://gabrielsilva.dev.br/glowie/docs/latest/forms-and-data/element" target="_blank">Element</a> instance with your component data.
